...
class AudioPreprocessor(torch.nn.Module):
    ...
    def forward(self, waveform, sr: int):
        """Function that applies the audio preprocessing to the data

        Args:
            waveform (torch.tensor): The waveform to be processed
            sr (int): The samplerate of the waveform

        Returns:
            torch.tensor: The processed waveform
        """
        ...
        # Apply gain with the chance specified
